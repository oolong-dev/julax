...
class BM(BaseModel):
    ...
    def __serialize_with_class_type__(self, default_serializer) -> Any:
        ...
        if isinstance(ret, dict):
            ret["klass"] = f"{self.__class__.__module__}.{self.__class__.__qualname__}"
        return ret
    ...
    def __convert_to_real_type__(cls, value: Any, handler):
        ...
        if class_full_name is None:
            raise ValueError("Missing klass field")
